...
class ConfidenceBall1_FJLT_Cholesky(LinearRegression_FJLT):
    """ 
        ConfidenceBall class recommending over a finite set
    """
    def recommend(self):
        ...
        ext = extrema(self.Vinv, beta_sqrt * np.sqrt(self.d), cholesky=True)
